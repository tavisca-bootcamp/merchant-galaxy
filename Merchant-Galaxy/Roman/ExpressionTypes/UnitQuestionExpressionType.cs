...
namespace Merchant_Galaxy.Roman.ExpressionTypes {
    public class UnitQuestionExpressionType : IExpression {
        ...
        public UnitQuestionExpressionType(CommodityIndex commodityIndex, AliasMapper aliasMap, IDecimalConverter converter, ExpressionValidationHelper helper) {
